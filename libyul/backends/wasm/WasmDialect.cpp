...
WasmDialect::WasmDialect()
{
	...
	m_functions["i32.store"_yulstring].sideEffects.storage = SideEffects::Pure;
	m_functions["i32.store"_yulstring].sideEffects.memory = SideEffects::Read;
	m_functions["i32.store"_yulstring].sideEffects.otherState = SideEffects::Pure;
	addFunction("i64.store", {i32, i64}, {}, false);
	m_functions["i64.store"_yulstring].sideEffects.storage = SideEffects::Pure;
	m_functions["i64.store"_yulstring].sideEffects.memory = SideEffects::Read;
	m_functions["i64.store"_yulstring].sideEffects.otherState = SideEffects::Pure;

	addFunction("i32.store8", {i32, i32}, {}, false);
	m_functions["i32.store8"_yulstring].sideEffects.storage = SideEffects::Pure;
	m_functions["i32.store8"_yulstring].sideEffects.memory = SideEffects::Read;
	m_functions["i32.store8"_yulstring].sideEffects.otherState = SideEffects::Pure;

	addFunction("i64.store8", {i32, i64}, {}, false);
	m_functions["i64.store8"_yulstring].sideEffects.storage = SideEffects::Pure;
	m_functions["i64.store8"_yulstring].sideEffects.memory = SideEffects::Read;
	m_functions["i64.store8"_yulstring].sideEffects.otherState = SideEffects::Pure;

	addFunction("i32.load", {i32}, {i32}, false);
	m_functions["i32.load"_yulstring].sideEffects.storage = SideEffects::Pure;
	m_functions["i32.load"_yulstring].sideEffects.otherState = SideEffects::Pure;
	...
	m_functions["i64.load"_yulstring].sideEffects.storage = SideEffects::Pure;
	m_functions["i64.load"_yulstring].sideEffects.otherState = SideEffects::Pure;
	...
	m_functions["unreachable"_yulstring].sideEffects.storage = SideEffects::Pure;
	m_functions["unreachable"_yulstring].sideEffects.otherState = SideEffects::Pure;
	m_functions["unreachable"_yulstring].sideEffects.memory = SideEffects::Pure;
...
void WasmDialect::addEthereumExternals()
{
	...
	for (External const& ext: externals)
	{
		...
		f.sideEffects.deterministic = true;
		...
		if (ext.name == "storageLoad")
			...
			f.sideEffects.storage = SideEffects::Pure;
